...
class TweetCell: UICollectionViewCell {
    ...
    private let infoLablel = UILabel()
    ...
    override init(frame: CGRect) {
        ...
        let captionStack = UIStackView(arrangedSubviews: [infoLablel, captionLabel])
        ...
        infoLablel.font = UIFont.systemFont(ofSize: 12)
        ...
        actionStack.anchor(bottom: bottomAnchor, paddingLeft: 8, paddingBottom: 8)
    ...
    func configure() {
        ...
        infoLablel.attributedText = viewModel.userInfoText
